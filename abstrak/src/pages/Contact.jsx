            ...
            <div className="row">
              <div className="col-xl-5 col-lg-6">
                <div className="contact-form-box shadow-box mb--30">
                  <h3 className="title">Feel free to contact our Team</h3>
                  <FormTwo />
                </div>
              </div>
              <div className="col-xl-5 col-lg-6 offset-xl-1">
                ...
                <div className="contact-info mb--30">
                  ...
                  <p>Our support team will get back to in 48-h Maximum.</p>
                  <h4 className="phone-number">
                    <a href="mailto:sterahcompany@gmail.com">
                      sterahcompany@gmail.com
                    </a>
                  </h4>
                </div>
              </div>
